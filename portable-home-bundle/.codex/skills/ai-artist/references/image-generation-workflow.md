...
python3 $HOME/.claude/skills/ai-artist/scripts/search.py "<keywords>" --domain examples --max-results 3

# Step 2: Generate with Flash
$HOME/.claude/skills/.venv/bin/python3 $HOME/.claude/skills/ai-multimodal/scripts/gemini_batch_process.py \
  --task generate \
