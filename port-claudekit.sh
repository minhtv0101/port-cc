...
SRC_SKILLS="${PORT_CLAUDEKIT_SRC_SKILLS:-$HOME/.claude/skills}"
SRC_WORKFLOWS="${PORT_CLAUDEKIT_SRC_WORKFLOWS:-$HOME/.claude/workflows}"
SRC_CLAUDE="${PORT_CLAUDEKIT_SRC_CLAUDE:-$HOME/.claude/CLAUDE.md}"

CODEX_SKILLS="${PORT_CLAUDEKIT_CODEX_SKILLS:-$HOME/.codex/skills}"
CODEX_WORKFLOWS="${PORT_CLAUDEKIT_CODEX_WORKFLOWS:-$HOME/.codex/workflows}"
CODEX_WORKFLOWS_REF="${PORT_CLAUDEKIT_CODEX_WORKFLOWS_REF:-\$HOME/.codex/workflows}"
CODEX_PROMPT="${PORT_CLAUDEKIT_CODEX_PROMPT:-$HOME/.codex/AGENTS.md}"
GEMINI_ROOT="${PORT_CLAUDEKIT_GEMINI_ROOT:-$HOME/.gemini}"
GEMINI_SKILLS="${PORT_CLAUDEKIT_GEMINI_SKILLS:-$HOME/.gemini/antigravity/skills}"
GEMINI_WORKFLOWS="${PORT_CLAUDEKIT_GEMINI_WORKFLOWS:-$HOME/.gemini/antigravity/global_workflows}"
GEMINI_WORKFLOWS_REF="${PORT_CLAUDEKIT_GEMINI_WORKFLOWS_REF:-\$HOME/.gemini/antigravity/global_workflows}"
GEMINI_PROMPT="${PORT_CLAUDEKIT_GEMINI_PROMPT:-$HOME/.gemini/GEMINI.md}"
